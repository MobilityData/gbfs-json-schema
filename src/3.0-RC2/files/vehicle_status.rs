...
pub struct Vehicle {
    ...
    /// The [VehicleType](crate::v3_0_rc2::files::vehicle_types::VehicleType) of this vehicle.
    ...
    /// If the vehicle is currently at a [Station](crate::v3_0_rc2::files::station_information::Station).
