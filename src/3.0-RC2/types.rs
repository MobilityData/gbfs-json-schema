...
#[cfg(doc)]
use crate::v3_0_rc2::files::gbfs::GbfsFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::gbfs_versions::GbfsVersionsFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::geofencing_zones::GeofencingZonesFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::station_information::StationInformationFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::station_status::StationStatusFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_alerts::SystemAlertsFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_information::SystemInformationFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_pricing_plans::SystemPricingPlansFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_regions::SystemRegionsFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::vehicle_status::VehicleStatusFile;
#[cfg(doc)]
use crate::v3_0_rc2::files::vehicle_types::VehicleTypesFile;

#[cfg(doc)]
use crate::v3_0_rc2::files::manifest::System;
#[cfg(doc)]
use crate::v3_0_rc2::files::station_information::Station;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_alerts::SystemAlert;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_information::SystemInformationData;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_pricing_plans::SystemPricingPlan;
#[cfg(doc)]
use crate::v3_0_rc2::files::system_regions::Region;
#[cfg(doc)]
use crate::v3_0_rc2::files::vehicle_status::Vehicle;
#[cfg(doc)]
use crate::v3_0_rc2::files::vehicle_types::VehicleType;
