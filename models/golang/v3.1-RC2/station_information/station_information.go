...
import (
	station_information_v31RC "github.com/MobilityData/gbfs-json-schema/models/golang/v3.1-RC/station_information"
...
type StationInformation struct {
	station_information_v31RC.StationInformation
