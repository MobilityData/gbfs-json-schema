...
import org.mobilitydata.v3_0.GBFSFeature;
...
class GeofencingZonesTest extends TestBase {
    @Test
    void testUnmarshal() {
        org.mobilitydata.v3_0.GBFSGeofencingZones zones = assertUnmarshalDoesNotThrow("v3_0/geofencing_zones.json", GBFSGeofencingZones.class);
