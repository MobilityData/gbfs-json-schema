...
import stationInformationPhysicalStationLimitedHoursOfOperationJson from '../../../testFixtures/v3.1-RC2/station_information_physical_station_limited_hours_of_operation.json';
import stationInformationVirtualStation from '../../../testFixtures/v3.1-RC2/station_information_virtual_station.json';
...
import systemPricingPlansAJson from '../../../testFixtures/v3.1-RC2/system_pricing_plans_a.json';
import systemPricingPlansBJson from '../../../testFixtures/v3.1-RC2/system_pricing_plans_b.json';
...
describe('GBFS Validator v3.1-RC2', () => {
    ...
    it('should check if station_information is valid for virtual stations', () => {
        expect(() => {
            StationInformation.check(stationInformationVirtualStation);
        }).not.toThrow();
    });
    ...
    it('should check if system_pricing_plans is valid for B', () => {
        expect(() => {
    ...
    it('should check if vehicle_status is valid for carsharing', () => {
        expect(() => {
            VehicleStatus.check(vehicleStatusCarsharingJson);
        }).not.toThrow();
    });

    it('should check if vehicle_status is valid for micromobility', () => {
        expect(() => {
